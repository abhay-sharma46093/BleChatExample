...
import com.infostride.blechatexample.states.DeviceConnectionState
import com.infostride.blechatexample.utils.MESSAGE_UUID
...
object ChatServer {
    ...
    private fun stopAdvertising() {
        ...
        if (advertiseCallback != null) advertiser?.stopAdvertising(advertiseCallback)
        advertiseCallback = null
    }


    private fun buildAdvertiseData(): AdvertiseData {
        val dataBuilder = AdvertiseData.Builder().addServiceUuid(ParcelUuid(SERVICE_UUID))
    ...
    private fun buildAdvertiseSettings(): AdvertiseSettings {
        return AdvertiseSettings.Builder()
            .setAdvertiseMode(AdvertiseSettings.ADVERTISE_MODE_LOW_POWER).setTimeout(0).build()
    }
    ...
    private class GattClientCallback : BluetoothGattCallback() {
        ...
        override fun onServicesDiscovered(discoveredGatt: BluetoothGatt, status: Int) {
            ...
            if (status == BluetoothGatt.GATT_SUCCESS) {
                ...
                if (service != null) messageCharacteristic = service.getCharacteristic(MESSAGE_UUID)
            }
        }
    }
